...
const response=await axios.post("https://crudcrud.com/api/eb90324b8dd94084b9291f3935552e99/restaurantdata",obj)
...
const id=li.id;
  li.remove();
  try {
    const response = await axios.delete(`https://crudcrud.com/api/eb90324b8dd94084b9291f3935552e99/restaurantdata/${id}`);
    console.log(response);
  } catch (err) {
    console.log(err);
  }
 ...
 window.addEventListener('DOMContentLoaded', async () => {
  try {
    const response = await axios.get("https://crudcrud.com/api/eb90324b8dd94084b9291f3935552e99/restaurantdata");
    let id;
